...
import { HeaderSection, SidebarSection, ContentSection } from "./MainPage.style";
import { SomeGrid } from "starter-domain/some-grid";
  ...
  <Page>
    ...
    <SidebarSection page-sidebar="true">
      <div>
        ...
        <NavMenu item={navMenuItem} selectedKey="main" />
      </div>
      <div>
